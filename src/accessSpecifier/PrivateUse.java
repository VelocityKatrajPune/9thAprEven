...
public class PrivateUse {
	...
	public static void main(String[] args)
	{
		...
		pu.test4();// protected can accesses within package/ outside of package using inheritance 
	...
	
	{
	 ...
	 protected void test4()
		 ...
		 {
				System.out.println("protected test4 method");//protected can be accessed within package, outside of package with inheritance
			} 
